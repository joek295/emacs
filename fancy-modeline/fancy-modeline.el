...
(defface mode-line-bufsize-face
  `((((class color) (min-colors 88)) 
     :foreground "#6c71c4" :weight bold :background "#073642")
    (((class color) (min-colors 8))
     :foreground "white" :background "black"))
